...
def get_test_data_from_excel():
    df = pd.read_excel("E:\\Offline_Batch_19\\Projects\\Automation_pnt19\\Project1-Fight_cost\\test_data.xlsx")
...
@pytest.mark.parametrize("distance_value, ticket_class, number_of_tickets, extra_baggage", get_test_data_from_excel())
