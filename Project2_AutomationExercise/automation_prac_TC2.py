...
from Project2_AutomationExercise.automation_prac_TC1 import account_creation
...
login_button = driver.find_element(By.XPATH,
                                   "/html//header[@id='header']/div[@class='header-middle']//ul[@class='nav navbar-nav']//a[@href='/login']")
login_button.click()
